...
import { LinuxIcon, AppleIcon, WindowsIcon, NpmIcon } from '@/components/InstallTabs';
...
- **Node.js 22 or later** - [Download Node.js](https://nodejs.org)
...
<Tabs items={['Linux', 'macOS', 'Windows', 'npm']}>
  <Tabs.Tab>
    ### Linux Installation
  ...
  <Tabs.Tab>
    ...
    **Manual binary installation:**
    ...
    ```bash
    # Download latest binary (Apple Silicon)
    curl -L https://github.com/codedir-labs/mimir-code/releases/latest/download/mimir-macos-arm64 -o mimir

    # Or for Intel Macs
    # curl -L https://github.com/codedir-labs/mimir-code/releases/latest/download/mimir-macos-x64 -o mimir
  ...
  <Tabs.Tab>
    ...
    **Manual binary installation:**
    ...
    ```powershell
    # Download latest binary
    Invoke-WebRequest -Uri "https://github.com/codedir-labs/mimir-code/releases/latest/download/mimir-win-x64.exe" -OutFile "$env:USERPROFILE\.mimir\bin\mimir.exe"

    # Add to PATH (one-time setup)
    $env:Path += ";$env:USERPROFILE\.mimir\bin"
  ...
  <Tabs.Tab>
    ...
    Install using your preferred Node.js package manager:
    ...
    **pnpm:**
    ```bash
    pnpm add -g @codedir/mimir-code
    mimir --version
    ```

    <Callout>
      Requires Node.js 22 or higher. This method is cross-platform and works on all systems.
    </Callout>
...
<Tabs.Tab>```bash yarn global upgrade @codedir/mimir-code ```</Tabs.Tab>

<Tabs.Tab>```bash pnpm update -g @codedir/mimir-code ```</Tabs.Tab>

  <Tabs.Tab>
    Download the latest binary from [GitHub Releases](https://github.com/codedir-labs/@codedir/mimir-code/releases) and replace the existing binary.
  </Tabs.Tab>
</Tabs>
...
<Tabs.Tab>```bash yarn global remove @codedir/mimir-code ```</Tabs.Tab>

<Tabs.Tab>```bash pnpm remove -g @codedir/mimir-code ```</Tabs.Tab>
...
- **Report bugs**: [GitHub Issues](https://github.com/codedir-labs/@codedir/mimir-code/issues)
- **Community**: [GitHub Discussions](https://github.com/codedir-labs/@codedir/mimir-code/discussions)
