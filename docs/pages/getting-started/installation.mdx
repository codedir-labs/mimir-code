...
<Tabs items={['npm', 'yarn', 'pnpm', 'Binary']}>
  ...
  <Tab>
    ...
    Download platform-specific binaries from [GitHub Releases](https://github.com/sebastianstupak/mimir/releases).

    **macOS / Linux:**
    ```bash
    # Download and extract
    curl -L https://github.com/sebastianstupak/mimir/releases/latest/download/mimir-macos.tar.gz | tar xz
    ...
    **Windows (PowerShell):**
    ```powershell
    # Download binary
    Invoke-WebRequest -Uri "https://github.com/sebastianstupak/mimir/releases/latest/download/mimir-windows.exe" -OutFile "mimir.exe"
...
irm https://github.com/sebastianstupak/mimir/releases/latest/download/install.ps1 | iex
```
...
<Tabs items={['npm', 'yarn', 'pnpm', 'Binary']}>
  ...
  <Tab>
    Download the latest binary from [GitHub Releases](https://github.com/sebastianstupak/mimir/releases) and replace the existing binary.
  </Tab>
</Tabs>
...
- **Report bugs**: [GitHub Issues](https://github.com/sebastianstupak/mimir/issues)
- **Community**: [GitHub Discussions](https://github.com/sebastianstupak/mimir/discussions)
