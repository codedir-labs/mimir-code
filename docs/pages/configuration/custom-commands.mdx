...
```yaml filename=".mimir/commands/my-command.yml"
name: my-command
...
```yaml filename=".mimir/commands/<command-name>.yml"
...
```yaml filename=".mimir/commands/security.yml"
name: security
...
```yaml filename=".mimir/commands/test.yml"
name: test
...
```yaml filename=".mimir/commands/review.yml"
name: review
