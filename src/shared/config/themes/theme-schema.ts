...
export interface ThemeJSON {
  ...
  colors: {
    ...
    statusIdle: ThemeColorJSON;
    statusReasoning: ThemeColorJSON;
    statusActing: ThemeColorJSON;
    statusObserving: ThemeColorJSON;
    statusInterrupted: ThemeColorJSON;

    // UI Elements (additional)
    borderColor: ThemeColorJSON;
    wizardTitle: ThemeColorJSON;
    wizardAccent: ThemeColorJSON;
    paramDescription: ThemeColorJSON;
...
export function parseThemeJSON(json: ThemeJSON): ThemeDefinition {
  const colors: ThemeColors = {
    ...
    statusIdle: parseColor(json.colors.statusIdle),
    statusReasoning: parseColor(json.colors.statusReasoning),
    statusActing: parseColor(json.colors.statusActing),
    statusObserving: parseColor(json.colors.statusObserving),
    statusInterrupted: parseColor(json.colors.statusInterrupted),

    borderColor: parseColor(json.colors.borderColor),
    wizardTitle: parseColor(json.colors.wizardTitle),
    wizardAccent: parseColor(json.colors.wizardAccent),
    paramDescription: parseColor(json.colors.paramDescription),
