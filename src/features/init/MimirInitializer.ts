...
import { getDatabaseManagerAsync, closeDatabaseManager } from '@codedir/mimir-agents-node/storage';
...
keyBindings:
  ...
  showTooltip: ${this.formatYamlArray(defaults.keyBindings.showTooltip)}
  ...
  newSession: ${this.formatYamlArray(defaults.keyBindings.newSession)}
  listSessions: ${this.formatYamlArray(defaults.keyBindings.listSessions)}
  resumeSession: ${this.formatYamlArray(defaults.keyBindings.resumeSession)}
